      ...
      <div className="flex justify-around items-center h-16">
        ...
        <Link
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition ${
            isActive('/mapa') ? 'text-green-700' : 'text-gray-600'
          }`}
        >
        ...
        {user && (
          <Link
            href="/reportar"
            className={`flex flex-col items-center justify-center flex-1 h-full transition ${
              isActive('/reportar') ? 'text-green-700' : 'text-gray-600'
            }`}
          >
        ...
        {usuario?.rol && ['experto', 'partner', 'founder'].includes(usuario.rol) && (
          <Link
            href="/dashboard"
            className={`flex flex-col items-center justify-center flex-1 h-full transition ${
              isActive('/dashboard') ? 'text-green-700' : 'text-gray-600'
            }`}
          >
            <span className="text-2xl">📋</span>
        ...
        {user ? (
          <Link
            href="/perfil"
            className={`flex flex-col items-center justify-center flex-1 h-full transition ${
              isActive('/perfil') ? 'text-green-700' : 'text-gray-600'
            }`}
          >
            <span className="text-2xl">👤</span>
