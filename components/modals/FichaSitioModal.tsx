...
export function FichaSitioModal({ idSitio, onClose }: FichaSitioModalProps) {
  ...
  async function cargarDatos() {
    try {
      // FIX: select('*') simple, sin JOINs que causaban PGRST201
  ...
  if (loading) {
    return (
      // FIX: z-[1000] (antes era z-50, quedaba bajo la navbar)
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            ...
            // FIX: calc(100vh - 56px) para que el tope del modal quede bajo la navbar (56px)
          ...
          >
            ...
            {/* FIX: paddingBottom 84px para que el botón Compartir no quede bajo el footer */}
      ...
      {/* ── Fullscreen foto — FIX: zIndex 2000 (antes 100, quedaba bajo el modal) ── */}
