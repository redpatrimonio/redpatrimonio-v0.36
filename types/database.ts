...
export type Database = {
  ...
  public: {
    Tables: {
      medios: {
        Row: {
          ...
          prioridad_visualizacion: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "medios_id_sitio_fkey"
            columns: ["id_sitio"]
            isOneToOne: false
            referencedRelation: "sitios_master"
            referencedColumns: ["id_sitio"]
          },
        ]
      }
      reportes_medios: {
        ...
        Relationships: [
          {
            foreignKeyName: "reportes_medios_id_reporte_fkey"
            columns: ["id_reporte"]
            isOneToOne: false
            referencedRelation: "reportes_nuevos"
      ...
      reportes_nuevos: {
        Row: {
          ...
          recinto_privado: boolean | null
          region: string | null
          timestamp_aprobado: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "reportes_nuevos_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
            referencedRelation: "usuarios_autorizados"
      ...
      sitios_master: {
        Row: {
          ...
          año_primer_registro: number | null
          categoria_general: string | null
          ...
          descubrimiento_origen: string | null
          estado_conservacion: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "sitios_master_id_reporte_fkey"
            columns: ["id_reporte"]
            isOneToOne: false
            referencedRelation: "reportes_nuevos"
            referencedColumns: ["id_reporte"]
    ...
    Functions: {
      ...
      limpiar_reportes_antiguos: { Args: never; Returns: number }
      ...
      sitios_cercanos: {
        Args: { lat: number; lon: number; radio_km?: number }
        Returns: {
          distancia_km: number
          id_sitio: string
          latitud: number
      ...
      tiene_permiso: { Args: { rol_requerido: string }; Returns: boolean }
